...
@parameter_validator
def nullable_cookie(x_token: Optional[str] = Cookie(default=None)):
    return {"x_token": x_token}


@app.get("/required_cookie")
@parameter_validator
def required_cookie(x_token: str = Cookie(max_length=5)):
    return {"x_token": x_token}


@app.get("/list_cookie")
@parameter_validator
def list_cookie(x_token: Optional[List[str]] = Cookie(default=None)):
    return {"x_token": x_token}
